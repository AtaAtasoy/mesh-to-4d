# mesh-to-4d This code is taken from Consistent4D (https://github.com/yanqinJiang/Consistent4D/blob/main/evaluation/compute_fvd.py)

# This code is reorganized from DisCo (https://github.com/Wangt-CN/DisCo?tab=readme-ov-file)
# The difference between the result computed by this code and the original one lies in the two decimal places. (误差在小数点后两位之后，即0.00x）
